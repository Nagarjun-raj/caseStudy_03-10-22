...
public class ItemData {
	...
	try {
		FileReader fileReader=new FileReader("D:/JavaGloballogic/SnackItem.txt");
		...
		while (true) {
			...
			SnackItem snackItem=new SnackItem(name,rate,status,discountRate,discountQty);
			itemMap.put(name,snackItem);
		}
